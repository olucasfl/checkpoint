...
const BUTTON =
  'min-h-11 rounded-[4px] px-4 font-display text-[13px] uppercase tracking-[0.1em] disabled:cursor-wait disabled:opacity-60';
    ...
    return (
      <div className="flex min-w-0 items-center gap-1">
        ...
        <button
          ...
          onClick={abrir}
          className="grid size-11 shrink-0 place-items-center rounded-[4px] text-texto-suave transition-colors hover:bg-acao-hover hover:text-ciano"
        >
