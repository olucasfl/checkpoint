...
- [ ] **CA-89** — _(atualizado por `troca-de-design-estante`, F1: o pulso do botão saiu; o topo novo vem na F2)_ **Dado** a página `/`, **quando** ela abre, **então** o topo mostra o logo "CHECKPOINT" com o ícone de bandeira e o botão "Adicionar jogo" com brilho pulsando (estático com `prefers-reduced-motion: reduce`).
